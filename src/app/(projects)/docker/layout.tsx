...
import { topicsByChapter } from "@/projects/docker/docker";

// Shell for every /docker/* route — same chrome as the typescript, hooks and
        ...
        <>
            <div className="flex min-h-screen">
                <Navbar
                    ...
                    basePath="/docker"
                    homeHref="/docker"
                    brand={{ eyebrow: "docker", sub: "containers · lab" }}
