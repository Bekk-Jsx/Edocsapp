...
import { topicsByChapter } from "@/projects/mongodb/mongodb";

// Shell for every /mongodb/* route — same chrome as the typescript, hooks and
        ...
        <>
            <div className="flex min-h-screen">
                <Navbar
                    ...
                    basePath="/mongodb"
                    homeHref="/mongodb"
                    brand={{ eyebrow: "mongodb", sub: "collections · lab" }}
