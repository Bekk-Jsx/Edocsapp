...
import { topicsByChapter } from "@/projects/couchdb/couchdb";

// Shell for every /couchdb/* route — same chrome as the typescript, hooks and
        ...
        <>
            <div className="flex min-h-screen">
                <Navbar
                    ...
                    basePath="/couchdb"
                    homeHref="/couchdb"
                    brand={{ eyebrow: "couchdb", sub: "documents · lab" }}
