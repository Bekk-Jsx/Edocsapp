...
import { topicsByChapter } from "@/projects/technical-seo/technical-seo";

// Shell for every /technical-seo/* route — same chrome as the typescript, hooks and
        ...
        <>
            <div className="flex min-h-screen">
                <Navbar
                    groups={groups}
                    mode="route"
                    basePath="/technical-seo"
                    homeHref="/technical-seo"
                    brand={{ eyebrow: "technical seo", sub: "crawl · lab" }}
